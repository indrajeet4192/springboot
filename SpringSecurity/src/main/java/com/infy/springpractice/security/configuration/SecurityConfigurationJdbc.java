package com.infy.springpractice.security.configuration;
...
public class SecurityConfigurationJdbc extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		//Custom schema , Add datasource details on application.properties
		/*.usersByUsernameQuery("select username, password, enabled from SCHEMA_NAME.users"
				+ "where username=?")
		.authoritiesByUsernameQuery("select username, authority"
				+ "from SCHEMA_NAME.authorities"
				+ "where username =?");*/
